...
public class RegistrationFragment4 extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button5:
                ...
                break;
            case R.id.button6:
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new NewsListFragment()).commit();
                Toast.makeText(getContext(),"Регистрация успешно выполнена!",Toast.LENGTH_SHORT).show();
                break;
        }
    }
}
